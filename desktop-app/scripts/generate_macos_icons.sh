...
TAURI_ICON_DIR="$GENERATED_ICON_DIR/tauri-icons"
...
cargo tauri icon "$SOURCE_ICON_PATH" --output "$TAURI_ICON_DIR"
cp "$TAURI_ICON_DIR/icon.icns" "$GENERATED_ICON_DIR/icon.icns"
